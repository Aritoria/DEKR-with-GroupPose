...
def update_config(cfg):
    cfg.defrost()
    cfg.merge_from_file("/mnt/private/MyCode/GroupPose/models/grouppose/config/w32_4x_reg03_bs10_512_adam_lr1e-3_coco_x140.yaml")
